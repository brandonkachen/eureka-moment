...
A: Information that is formatted in a way that allows computers
to draw meaning and execute tasks.

## What is a programming language?

A: A set of characters, words, and grammar to communicate
meaning to a computer, so it can execute commands for you.
...
covered by a field called _linguistics_. Super cool stuff, feel free to
learn more about it.)
...
software on their own computers but share them with people using
...
## Why was it important to be fast? Aren't computers fast enough?

A: At the time, computers were super slow. We've all heard about
how our modern cell phones have more power than NASA's super
computers. And something called Moore's law, which I won't
repeat here but you can find excellent resources explaining it.

## C++ brought the idea of _classes_ to the mix. What are classes?
...
use it. This idea is called _abstraction_.
...
## OK, this is cool and all, but the software world moves super fast. Nowadays, there are hundreds of different computer languages. Is C++ still relevant?
...
it. And some of its ideas, like classes, are still fundamental
to modern day programming. C and C++ are still in the top 10 most
popular languages list in 2020
