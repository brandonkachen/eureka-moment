...
<BlankComp answers={["Information", "perform"]} qid="yae7" {...props}>
...
<BlankComp answers={["characters", "meaning"]} qid="jkn1" {...props}>
...
<BlankComp answers={["ideas"]} qid="fws9" {...props}>
  A: They express `___` and methods for accomplishing tasks. If you're fluent in
  a language, you can use it to properly communicate with someone else who is
  also fluent.
</BlankComp>
