...
{meaning} to a computer, so it can perform actions for you.
...
computers. And something called Moore's law, which we won't
repeat here but you can find excellent resources explaining it.
Additionally, the faster one can perform tasks, the slower the processor
you need in order to accomplish the same thing. This leads to {cheaper}
hardware and better {future}-proofing.
